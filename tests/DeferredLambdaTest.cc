...
TEST(NewtonTest, 2DDeformationFloat) { test_compilation_time<float>(); }
TEST(NewtonTest, 2DDeformationDouble) { test_compilation_time<double>(); }
TEST(NewtonTest, 2DDeformationLongDouble) { test_compilation_time<long double>(); }
